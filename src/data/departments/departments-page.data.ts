export const departmentsPageData = {
  ...
  departments: [
    {
      ...
      services: ['Brain Monitoring', 'EEG Testing', 'Neurological Exam', 'Treatment Plans'],
    },
    {
      name: 'Surgery',
    ...
    },
    {
      ...
      description: 'Omnis dolor repellendus temporibus autem quibusdam et aut officiis debitis aut rerum necessitatibus saepe eveniet ut et voluptates repudiandae.',
  ...
  departmentsGrid: [
    ...
    { name: 'Dermatology', description: 'Complete skin care services from medical dermatology to cosmetic procedures for healthy, beautiful skin.' },
    { name: 'Oncology', description: 'Comprehensive cancer care with multidisciplinary approach and latest treatment options for all cancer types.' },
  ],
}
